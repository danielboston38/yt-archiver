...
def cmd_serve(host: str = "127.0.0.1", port: int = 8000, open_browser: bool = False):
    try:
        import uvicorn
    except ImportError:
...
def main():
    ...
    p_serve = sub.add_parser("serve", help="Start local web UI")
    ...
    if args.command == "add":
        ...
        cmd_serve(host=args.host, port=args.port, open_browser=args.open_browser)
